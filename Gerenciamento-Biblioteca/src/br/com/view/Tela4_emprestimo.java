...
public class Tela4_emprestimo extends javax.swing.JFrame {
    ...
    public Tela4_emprestimo() {
        ...
        jTPid.setText("" + (lista.getEmprestimos().size() + 1));
        alimentarCB();
        tudoInvisivel();
        tornarGrid();
    ...
    public Tela4_emprestimo(Listas lista) {
        initComponents();
        this.lista = lista;
        Toolkit kit = Toolkit.getDefaultToolkit();
        this.setIconImage(kit.getImage(this.getClass().getResource("images/icon.png")));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jBefetuar);
        jBefetuar.setBounds(250, 370, 180, 50);
        ...
        jTtabelaEmprestimo.setFocusable(false);
        jScrollPane1.setViewportView(jTtabelaEmprestimo);
        if (jTtabelaEmprestimo.getColumnModel().getColumnCount() > 0) {
            jTtabelaEmprestimo.getColumnModel().getColumn(0).setMaxWidth(20);
            jTtabelaEmprestimo.getColumnModel().getColumn(1).setMaxWidth(100);
            jTtabelaEmprestimo.getColumnModel().getColumn(3).setMaxWidth(200);
            jTtabelaEmprestimo.getColumnModel().getColumn(5).setMaxWidth(150);
            jTtabelaEmprestimo.getColumnModel().getColumn(6).setMaxWidth(150);
        }

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(30, 480, 600, 110);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Aluno");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(20, 100, 70, 100);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Livro");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(21, 207, 70, 90);

        jCBaluno.setPreferredSize(new java.awt.Dimension(70, 20));
        jPanel1.add(jCBaluno);
        jCBaluno.setBounds(110, 140, 280, 30);

        jCBlivro.setPreferredSize(new java.awt.Dimension(70, 20));
        jPanel1.add(jCBlivro);
        jCBlivro.setBounds(110, 230, 280, 30);
        ...
        jScrollPane2.setBounds(110, 310, 80, 30);

        jTPid.setFocusable(false);
        jScrollPane3.setViewportView(jTPid);

        jPanel1.add(jScrollPane3);
        jScrollPane3.setBounds(100, 60, 80, 30);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("ID");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(20, 57, 70, 40);

        jLabel7.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("Data");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 300, 70, 50);
        ...
        jTmatricula.setBounds(440, 130, 180, 30);
        ...
        jPanel1.add(jBpesquisarMat);
        jBpesquisarMat.setBounds(450, 170, 160, 23);
        ...
        jTcodigo.setBounds(440, 230, 180, 30);
        ...
        jPanel1.add(jBpesquisarCodigo);
        jBpesquisarCodigo.setBounds(450, 270, 160, 23);
        jPanel1.add(jSeparator1);
        jSeparator1.setBounds(20, 50, 630, 20);
        jPanel1.add(jSeparator2);
        jSeparator2.setBounds(20, 300, 630, 10);

        jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel1.add(jSeparator3);
        jSeparator3.setBounds(650, 50, 20, 300);
        jPanel1.add(jSeparator5);
        jSeparator5.setBounds(20, 200, 630, 10);
        jPanel1.add(jSeparator6);
        jSeparator6.setBounds(20, 350, 630, 20);
        jPanel1.add(jSeparator7);
        jSeparator7.setBounds(20, 100, 630, 10);

        jLabel1.setText("Código");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(510, 210, 40, 16);

        jLabel2.setText("Matrícula");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(510, 110, 50, 10);

        jSeparator9.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel1.add(jSeparator9);
        jSeparator9.setBounds(90, 50, 20, 300);

        jSeparator10.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel1.add(jSeparator10);
        jSeparator10.setBounds(20, 50, 20, 300);

        jSeparator11.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanel1.add(jSeparator11);
        jSeparator11.setBounds(400, 100, 20, 200);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(260, 10, 150, 30);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Empréstimos Recentes");
        jLabel8.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(jLabel8);
        jLabel8.setBounds(240, 440, 200, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(110, 50, 670, 610);
    ...
    private void jBefetuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBefetuarActionPerformed
        if (lista.getAlunos().size() != 0 || lista.getLivros().size() != 0) {   
            if (!(jCBlivro.getItemCount() == 0 || jCBaluno.getItemCount() == 0)) {
                ...
                int veri = JOptionPane.showOptionDialog(null, "Matrícula: " + matriculaAluno + 
                                                              "\nAluno: " + nomeAluno +
                ...
                if (veri == 0) {
                   lista.armazenaEmprestimo(id, matriculaAluno, nomeAluno, codigoLivro, nomeLivro, data, data.plusDays(7), "X");
                   lista.colocarSituacao(matriculaAluno, "P.E", codigoLivro, "X");
                   tabelaRecentes(lista);
                }
                ...
                JOptionPane.showMessageDialog(null, "Não há mais alunos ou livros para fazer empréstimos."); 
            }
        } else {
    ...
    private void jBpesquisarMatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesquisarMatActionPerformed
        ...
        if (matricula.trim().equals("")) {
            ...
            if (veri) {
                ...
                for (Emprestimo emprestimo : lista.getEmprestimos()) {
                    if (emprestimo.getMatriculaAluno().equals(matricula) && emprestimo.getSituacao().equals("X")) {
                        veri2 = false;
                    }
                }
                ...
                if (veri2) {
                    ...
                    JOptionPane.showMessageDialog(null, "Aluno já pegou um livro emprestado.");
                }
    ...
    private void jBpesquisarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesquisarCodigoActionPerformed
        ...
        if (codigo.trim().equals("")) {
            ...
            if (veri) {
                ...
                for (Emprestimo emprestimo : lista.getEmprestimos()) {
                    if (emprestimo.getCodigoLivro().equals(codigo) && emprestimo.getSituacao().equals("X")) {
                        veri2 = false;
                    }   
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela4_emprestimo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela4_emprestimo().setVisible(true);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
     ...
     public void tabelaRecentes(Listas lista) {
        DefaultTableModel recentes = (DefaultTableModel) jTtabelaEmprestimo.getModel();

        for (int i = 0; i < 5; i++) {
            recentes.removeRow(0);
        }

        for (int i = lista.getEmprestimos().size() - 1; i > lista.getEmprestimos().size() - 6; i--) {

            if (i >= 0) {
                recentes.addRow(lista.imprimeEmprestimo(i));
            } else {
